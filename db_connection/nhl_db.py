            ...
            if self.cursor.fetchone() != None:
                ...
                if self.cursor.fetchone() != None:
                    ...
                    SET homeScore = %s,
                        ...
                        awayPenaltyMins = %s
                    WHERE matchID = %s                 
                ''',(temp.home_score,temp.away_score,temp.home_shots,temp.away_shots,
                     temp.home_shorthanded_goals,temp.away_shorthanded_goals,
                     temp.home_powerplay_goals,temp.away_powerplay_goals,
                     temp.home_faceoffs_won,temp.away_faceoffs_won,
                     temp.home_penalty_mins,temp.away_penalty_mins,match_id)
                )
            else:
